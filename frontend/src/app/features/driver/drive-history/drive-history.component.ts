...
@Component({
  selector: 'app-drive-history',
  templateUrl: './drive-history.component.html',
  styleUrl: './drive-history.component.css'
})
export class DriveHistoryComponent implements OnInit {
  rides: any[] = [];
  ...
  ngOnInit(): void {
    this.rideService.getRideHistoryDriver(this.authService.userEmail).subscribe((rides: any[]) => {
